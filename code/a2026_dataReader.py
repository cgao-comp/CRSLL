...
class DataReader_snapshot():
    ...
    def generate_data(self):
        ...
        for g in tqdm(self.rumor_extend_cascade):
            ...
            num_infected_nodes_to_select = max(1, int(0.3 * len(infected_nodes)))  
